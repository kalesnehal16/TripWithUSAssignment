...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  res.json({ sortedHotelsByPricing: hotelsCopy });
  // res.json(hotelsCopy);
});
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  res.json({ sortedHotelsByRating: hotelsCopy });
  // res.json(hotelsCopy);
});
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  res.json({ sortedHotelsByReviews: hotelsCopy });
  // res.json(hotelsCopy);
});
...
app.get('/hotels/filter/amenity', (req, res) => {
  ...
  let filterBasedOnAmenity = hotels.filter((hotel) =>
    filterByAmenity(hotel, amenity)
  );
  //res.json(filterBasedOnAmenity);
  res.json({ HotelsBasedOnAmenity: filterBasedOnAmenity });
});
...
app.get('/hotels/filter/country', (req, res) => {
  ...
  let filterBasedOnCountry = hotels.filter((hotel) =>
    filterByCountry(hotel, country)
  );
  //res.json(filterBasedOnCountry);
  res.json({ HotelsBasedOnCountry: filterBasedOnCountry });
});
